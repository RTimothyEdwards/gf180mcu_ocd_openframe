...
module simple_spi_master_wb #(
    ...
    output 	 sdoena, // SPI output enable
	...
	.spi_enabled(spi_enabled),	// Mux pins with GPIO
    	...
    	.sck(sck),	 // SPI clock
    	.sdo(sdo),	 // SPI output
    	.sdoena(sdoena), // SPI output enable
...
module simple_spi_master (
    ...
    assign reg_dat_do = done ? {24'b0, rreg} : ~0;
