...
# reset - synchronized
set_false_path -from [get_ports resetb_core]

# SPI SCK - synchronized
set_false_path -from [get_ports gpio_in\[4\]]

# SPI CSB - synchronized
set_false_path -from [get_ports gpio_in\[3\]]

# SPI SDI (IO1) - synchronized
set_false_path -from [get_ports gpio_in\[2\]]

# SPI SDO (IO0) - synchronized
# set_false_path -from [get_ports gpio_out\[1\]]

# Probably need the UART and SPI master signals, too.
# And IRQ inputs?

# fpga_mode_i - static configuration
# set_false_path -from [get_ports gpio_in\[0\]]
